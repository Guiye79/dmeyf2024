# Corrida general del Workflow Semillerio 990_competencia_3_004b.r
...
wf_competencia_3_004b <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/dataset_iter_COMP3_1.csv.gz")
