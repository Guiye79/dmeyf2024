require( "data.table" ) # 999_variables_evolutivas_iter_1_COMP3.r
...
nombre_archivo <- paste0("nuevas_variables_iter_COMP3", k, ".txt")
...
nombre_dataset <- paste0("dataset_iter_COMP3_", k, ".csv.gz")
